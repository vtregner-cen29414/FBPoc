 ...
 */
public class RoundedProfilePictureView extends FrameLayout {
     ...
     */
    public static final String TAG = RoundedProfilePictureView.class.getSimpleName();
    ...
    private void setImageBitmap(Bitmap imageBitmap) {
        if (image != null && imageBitmap != null) {
            ...
            image.setImageBitmap(getCroppedBitmap(imageBitmap));
        }
    }
    ...
    public Bitmap getCroppedBitmap(Bitmap bitmap) {
        ...
        if (borderColor != -1) {
            ...
            paintStroke.setStrokeWidth(getBorderWidth() != 0 ? getBorderWidth() : 1f);                       // set stroke widht to 1 px
            paintStroke.setColor(getBorderColor());                     // set color
            RectF oval = new RectF(rect.left+2, rect.top+2, rect.right-2, rect.bottom-2);
            canvas.drawArc(oval, 0f, 360f, true, paintStroke);    // draw arch from 0 to 360 degrees (i. e. closed circle)
        }
